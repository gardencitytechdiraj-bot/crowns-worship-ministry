const translations = {
  en: {
    navAbout: "About", navMinistry: "Ministry", navReach: "Reach", navGallery: "Gallery", navGive: "Give", navConnect: "Connect",
    heroEyebrow: "Based in Pokhara, Nepal", heroLine1: "Worship", heroLine2: "that sounds", heroLine3: "like hope.",
    heroLede: "Raising worship. Equipping a generation. Serving Nepal — from the room we call home to every mountain, valley, and village beyond it.", heroPrimary: "Join the mission", heroSecondary: "See the journey", heroSignature: "A youth worship movement for a living Nepal.", heroCaption: "A room full of yes", heroFact: "districts reached", scrollCue: "Scroll to discover",
    impactIntro: "One movement, many doorways.", statDistricts: "Districts reached", statLeaders: "Leaders graduated", statProvinces: "Provinces covered", statEvents: "Training events",
    storyKicker: "Who we are", storyTitle: "A worship movement with both feet on the ground.", storyLead: "Crown's Worship Ministry is headquartered in Ranipouwa, Pokhara — a home base, a training ground, and the place where every journey begins.", storyBody: "We travel across Nepal to train worship teams, mentor new leaders, and serve families in need. We believe worship is more than a moment on a stage. It is a way of living that makes room for courage, care, and community.", storyLink: "What we carry", storyQuote: "From Pokhara to the mountains — we want a Nepal alive with the sound of worship.",
  ...
  ne: {
    navAbout: "हाम्रो बारेमा", navMinistry: "सेवकाइ", navReach: "पहुँच", navGallery: "ग्यालरी", navGive: "दान", navConnect: "सम्पर्क",
    heroEyebrow: "पोखरा, नेपालबाट", heroLine1: "आशा जस्तै", heroLine2: "सुनिने", heroLine3: "आराधना।", heroLede: "आराधना उठाउँदै। नयाँ पुस्तालाई तयार गर्दै। नेपाललाई सेवा गर्दै — हाम्रो घरको कोठादेखि हरेक पहाड, उपत्यका र गाउँसम्म।", heroPrimary: "मिशनमा जोडिनुहोस्", heroSecondary: "यात्रा हेर्नुहोस्", heroSignature: "जीवित नेपालको लागि युवा आराधना आन्दोलन।", heroCaption: "‘हुन्छ’ ले भरिएको कोठा", heroFact: "पुगेका जिल्लाहरू", scrollCue: "अझ हेर्नुहोस्",
    impactIntro: "एउटै आन्दोलन, धेरै बाटाहरू।", statDistricts: "पुगेका जिल्लाहरू", statLeaders: "तयार भएका अगुवाहरू", statProvinces: "समेटिएका प्रदेशहरू", statEvents: "तालिम कार्यक्रमहरू",
    storyKicker: "हामी को हौं", storyTitle: "जमिनसँग जोडिएको आराधनाको आन्दोलन।", storyLead: "Crown's Worship Ministry को मुख्य आधार रणिपौवा, पोखरा हो — एउटा घर, तालिमको ठाउँ, र हरेक यात्राको सुरुवात।", storyBody: "हामी नेपालभरि आराधना टोलीलाई तालिम दिन्छौं, नयाँ अगुवाहरूलाई मार्गदर्शन गर्छौं, र आवश्यकतामा रहेका परिवारहरूलाई सेवा गर्छौं। हाम्रो लागि आराधना मञ्चको एक क्षण मात्र होइन। यो साहस, हेरचाह र समुदायका लागि ठाउँ बनाउने जीवनशैली हो।", storyLink: "हामी के बोक्छौं", storyQuote: "पोखरादेखि पहाडसम्म — हामी आराधनाको आवाजले जीवित नेपाल देख्न चाहन्छौं।",
...
function setLanguage(language) {
  ...
  languageLabels.forEach((node) => { node.textContent = language === 'en' ? 'नेपाली' : 'English'; });
  languageButtons.forEach((button) => button.setAttribute('aria-pressed', String(language === 'ne')));
}
...
if ('IntersectionObserver' in window) {
  const sectionObserver = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) sectionLinks.forEach((link) => link.classList.toggle('is-active', link.getAttribute('href') === `#${entry.target.id}`));
...
const renderGalleryItem = (item, index) => {
  ...
  if (lightboxCount) lightboxCount.textContent = `${index + 1} / ${galleryItems.length}`;
};
...
const closeLightbox = () => {
  ...
  document.body.classList.remove('is-locked');
  lastFocusedGalleryItem?.focus({ preventScroll: true });
